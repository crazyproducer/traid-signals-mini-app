...
export default function MainMenu() {
  ...
  return (
    <div className="page-padding" style={{ paddingTop: '0px', paddingBottom: '96px' }}>
      {/* Header */}
      <div style={{ position: 'sticky', top: 0, zIndex: 40, paddingTop: '0px', paddingBottom: '10px', marginLeft: '-20px', marginRight: '-20px', paddingLeft: '20px', paddingRight: '20px', backgroundColor: 'var(--tg-theme-bg-color, #fff)', borderBottom: '1px solid rgba(128,128,128,0.12)' }}>
